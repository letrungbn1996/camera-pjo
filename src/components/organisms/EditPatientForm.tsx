...
import { MainBody, MainLead, MainBtm } from '../../components/organisms/Main'
import {
    RegistSection,
    RegistHeader,
    RegistBody,
...
const EditPatientForm = ({ patientData, setOpenCompleteDialog }: Props) => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <MainBody>
                <RegistSection>
                    <RegistHeader>
                        <h2 className="headerTitle">編集するご家族情報</h2>
                    </RegistHeader>
                    <RegistBody>
                        <RegistInput>
                            <div className="label">
