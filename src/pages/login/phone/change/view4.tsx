...
const LoginPage: NextPage = () => {
    ...
    const onSubmit: SubmitHandler<FormData> = (data) => {
        console.log(data)
        router.push('/login/phone/change/view5')
    }
            ...
            <DefaultLayout>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <Initial>
                        <InitialSection>
                            <InitialLead>
                                変更後の携帯電話番号宛にショートメッセージでパスコードを送信しました。（パスコードの有効期限は30分です。有効期限が切れた場合には戻って、再度、携帯電話番号をご入力ください）
                                <br />
                                <br />
                                パスコードをご入力頂くことで、携帯電話番号の変更が完了します。
                            </InitialLead>
                            <Box
                                sx={{
                                    pt: '25px',
